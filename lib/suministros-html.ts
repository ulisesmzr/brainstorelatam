// FIX v3: logos dorados + datos de contacto reales
// email: team-bsm@brainstore.com.mx
// tel/wa: +52 55 6506 7332
// Size: 296 KB
  ...
  <div class="max-w-[1440px] mx-auto px-6 lg:px-12">
    ...
    <div class="footer-hero">
      ...
      <div class="footer-coverage">
        <div class="footer-coverage-num">10</div>
        <div class="footer-coverage-text">
          países Latinoamérica
          <span class="footer-coverage-text-sub">Cobertura sin abrir oficinas locales</span>
        </div>
      </div>
    ...
    <div class="footer-grid">
      ...
      <div>
        ...
        <div class="footer-contact-item">
          <svg class="footer-contact-icon"><use href="#i-search"/></svg>
          <div class="footer-contact-text">
            <span class="footer-contact-label">Atención comercial</span>
            <a class="footer-contact-value" href="mailto:team-bsm@brainstore.com.mx">team-bsm@brainstore.com.mx</a>
          </div>
        </div>

        <div class="footer-contact-item">
          <svg class="footer-contact-icon"><use href="#i-clock"/></svg>
          <div class="footer-contact-text">
            <span class="footer-contact-label">Teléfono</span>
            <a class="footer-contact-value" href="tel:+525565067332">+52 55 6506 7332</a>
          </div>
        </div>

        <div class="footer-contact-item">
          <svg class="footer-contact-icon"><use href="#i-package"/></svg>
          <div class="footer-contact-text">
            <span class="footer-contact-label">Oficinas centrales</span>
            <span class="footer-contact-value">Ciudad de México, México</span>
          </div>
        </div>
        ...
        <div class="footer-social">
          ...
          <a href="https://wa.me/525565067332" target="_blank" rel="noopener" class="footer-social-btn" aria-label="WhatsApp">
